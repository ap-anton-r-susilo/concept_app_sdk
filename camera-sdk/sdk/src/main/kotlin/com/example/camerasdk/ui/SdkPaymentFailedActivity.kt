...
class SdkPaymentFailedActivity : ComponentActivity() {
    ...
    @Composable
    private fun FailedScreen(reason: String, onConfirm: () -> Unit) {
        Scaffold(
    ...
    companion object {
        const val EXTRA_FAILURE_REASON = "sdk_failure_reason"
    }
}
